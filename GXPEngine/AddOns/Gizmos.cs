...
namespace Saxion.CMGT.Algorithms.GXPEngine.AddOns {
	...
	public class Gizmos {
		...
		/// using DrawLine.
		/// </summary>
		public static void DrawRectangleCenter(float xCenter, float yCenter, float width, float height, GameObject space = null, uint color = 0, byte lineWidth = 0) {
		...
		public static void DrawRectangle(float x, float y, float width, float height, GameObject space = null, uint color = 0, byte lineWidth = 0) {
			DrawLine(x, y, x + width, y, space, color, lineWidth);
			DrawLine(x + width, y, x + width, y + height, space, color, lineWidth);
			DrawLine(x + width, y + height, x, y + height, space, color, lineWidth);
			DrawLine(x, y + height, x, y, space, color, lineWidth);
		}
